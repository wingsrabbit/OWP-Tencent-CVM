...
OWP Tencent CVM v0.7 is intended to be shipped as a public source package that
...
5. Open the addon page and confirm version `0.7`.
...
- Reinstall remains blocked and makes no Tencent Cloud API call in v0.7.
