...
OWP Tencent CVM v0.8.2 is intended to be shipped as a public source package that
...
5. Open the addon page and confirm version `0.8.2`.
...
- Addon page shows version `0.8.2`.
...
- Reinstall remains blocked and makes no Tencent Cloud API call in v0.8.2.
