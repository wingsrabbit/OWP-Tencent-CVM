...
<div class="owp-tencentcvm-clientarea">
    <div class="owp-cvm-shell">
        ...
        <details class="owp-cvm-details owp-cvm-details-danger">
            ...
            <div class="owp-cvm-details-body">
                <p class="owp-cvm-help">Reinstall is intentionally isolated and blocked in v0.8.1. Future support will require an admin policy switch and typed confirmation.</p>
                <form method="post">
