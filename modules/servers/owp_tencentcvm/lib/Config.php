...
final class Config
{
    ...
    {
        return defined('OWP_TENCENTCVM_VERSION') ? OWP_TENCENTCVM_VERSION : '0.8.2';
    }
    ...
    public static function clientAreaVariables(array $params): array
    {
        return [
            ...
            'notice' => 'Client-area controls are guarded by admin safety settings, CSRF protection, and dry-run policy in v0.8.2.',
        ];
    }
}
